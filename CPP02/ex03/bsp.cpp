...
//	std::cout << ab.getX() * ap.getY() - ab.getY() * ap.getX() << std::endl;
//	std::cout << ab.getX() * ac.getY() - ab.getY() * ac.getX() << std::endl;
//	std::cout << "test2" << std::endl;
//	std::cout << bc.getX() * bp.getY() - bc.getY() * bp.getX() << std::endl;
//	std::cout << bc.getX() * ba.getY() - bc.getY() * ba.getX() << std::endl;
//	std::cout << "test3" << std::endl;
//	std::cout << ca.getX() * cp.getY() - ca.getY() * cp.getX() << std::endl;
//	std::cout << ca.getX() * cb.getY() - ca.getY() * cb.getX() << std::endl;
